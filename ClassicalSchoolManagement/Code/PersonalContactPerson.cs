...
public class PersonalContactPerson
{
    ...
    public static List<PersonalContactPerson> parse(MySqlDataReader reader)
    {
        List<PersonalContactPerson> listParents = new List<PersonalContactPerson>();
        try
        {
            while (reader.Read())
            {
                PersonalContactPerson cp = new PersonalContactPerson();
    ...
    public static PersonalContactPerson getParentInfoByIdCard(string idCard)
    {
        PersonalContactPerson parent = null;
    ...
    public static void Add(PersonalContactPerson p)
    {
...
student_id)
    ...
    public static void updateParents(PersonalContactPerson p)
    {
        string constr = ConfigurationManager.ConnectionStrings["constr"].ConnectionString;
        MySqlConnection con = new MySqlConnection(constr);
        MySqlCommand cmd;
    ...
    public static List<PersonalContactPerson> getListParentsInfo(PersonalContactPerson p)
    {
        List<PersonalContactPerson> listResult = null;
        string constr = ConfigurationManager.ConnectionStrings["constr"].ConnectionString;
    ...
    public static PersonalContactPerson getListParentsById(int id)
    {
        PersonalContactPerson p = null;
        string constr = ConfigurationManager.ConnectionStrings["constr"].ConnectionString;
    ...
    public static PersonalContactPerson getParentsInfoByReferenceCode(string code)
    {
        PersonalContactPerson parentInfo = null;
        string constr = ConfigurationManager.ConnectionStrings["constr"].ConnectionString;
